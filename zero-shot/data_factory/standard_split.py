...
class SSFactory(Dataset):
    def __init__(self, 
        ...
        self.all_attr = prepare_attribute_matrix(attr_file)
        ...
        self.attr_selected = self.all_attr[np.asarray(cls_indice), :]
        ...
        # with open('/data/ydr2021/ydr/AttentionZSL/data/AwA2/mln/image_name_SS.json', 'w', encoding='UTF-8') as fp:
        #      fp.write(json.dumps(self.file_dict))
