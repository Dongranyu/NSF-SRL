...
import sys
sys.path.append(r"C:\Users\Administrator\Desktop\ExpressGNN-maste\ExpressGNN-master\common")
...
cmd_opt.add_argument('-gcn_free_size', default=127, type=int, help='embedding size of GCN concat params')
cmd_opt.add_argument('-slice_dim', default=16, type=int, help='slice dimension of posterior params')
cmd_opt.add_argument('-data_root', default='../data/fb15k-237/', help='root of data_process')
...
cmd_opt.add_argument('-batchsize', default=16, type=int, help='batch size for training')

cmd_opt.add_argument('-trans', default=0, type=int, help='GCN transductive or inductive')
cmd_opt.add_argument('-num_hops', default=1, type=int, help='num of hops in GCN')
...
cmd_opt.add_argument('-lr_decay_patience', default=100, type=float, help='learning rate decay patience')
